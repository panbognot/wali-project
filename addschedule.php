...
<div id="float">
		...
		<div id='external-events'>
			<h4>Drag Cluster to create events</h4>
			<?php
				for($i = 0; $i < $countClusters; $i++) {
					echo "<div class=\"external-event\" id=\"".$clustersArray[$i]['clusterid']."\" name=\"".$clustersArray[$i]['name']."\">".$clustersArray[$i]['name']."</div>";
				}
			?>
			<p>
		...
		<div class="container-fluid">
			<p>&nbsp;</p>
			<div class="row">
				<a id="saveSchedule" class="btn btn-warning btn-lg btn-block" href="./addschedule.php" disabled>Save Schedule</a>
			</div>
		</div>
	</div>
