		...
		<form class="form-horizontal">
			...
			<?php
				...
				*/
				...
				$sql="SELECT * FROM alarm_schedule WHERE clusterid=".$_GET['clusterid']." ORDER BY scheduleid ASC";
				$result=mysql_query($sql);
				$row=mysql_fetch_array($result);
			...
			?>
			<div class="form-group">
				<label for="dayOfWeek" class="control-label col-sm-offset-1 col-sm-2">Day of Week</label>
				<div class="col-sm-3">
				...
				<label for="activateTime" class="control-label col-sm-offset-1 col-sm-2">Activation Time</label>
				<div class="col-sm-3">
					<input id="activateTime" name="activateTime" type="text" class="time form-control" value ="<?php echo $schedule[0]['activate_time'];?>" >
				</div>
			</div>
			...
			<div class="form-group">
				...
				<label for="activateTime" class="control-label col-sm-offset-1 col-sm-2">Activation Time</label>
				<div class="col-sm-3">
					<input id="activateTime" name="activateTime" type="text" class="time form-control" value ="<?php echo $schedule[1]['activate_time'];?>" >
				</div>
			</div>
			<div class="form-group" id="brightnessSlider">
				<label for="brightness" class="col-sm-offset-1 col-sm-2 control-label">Brightness</label>
...
<script>
	...
	var level = <?php echo $schedule[0]['brightness'];?>;
	$(function() {
