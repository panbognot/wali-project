		...
		<form class="form-horizontal">
			...
			<?php
				...
				*/
				...
				$sql="SELECT * FROM alarm_schedule WHERE clusterid=".$_GET['clusterid'];
				$result=mysql_query($sql);
				$row=mysql_fetch_array($result);
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input id="dayOfWeek" name="dayOfWeek" type="text" class="form-control" value ="<?php echo $schedule[0]['day_of_week'];?>" >
